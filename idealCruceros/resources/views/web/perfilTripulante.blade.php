                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            <li class="nav-item">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " href="{{ route('web.tripulante',auth()->user()->id_usuario) }}" role="tab" aria-controls="teams" aria-selected="false">
                                    ...
                                    <button type="button" class="btn btn-primary btn-md">{{ 'Viajes Programados' }}</button>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('user.updateTripulante', auth()->user()->id_usuario) }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
